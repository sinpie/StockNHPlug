...
전략 화면 상단의 **현금 관리 → 파킹 설정**에서 켜기/끄기, 6자리 종목코드, 최소 현금, 최대 파킹 평가금액, 1회 주문 한도, 하루 매수+매도 한도, 최소 주문금액, 주문 간격을 편집합니다. 기본은 꺼짐/종목 미지정입니다. 기본 금액은 최소 현금 5만원, 최대 파킹 100만원, 1회 10만원, 하루 회전 30만원, 최소 주문 1만원, 간격 300초입니다. 이는 설정 시작값이며 투자 권고가 아닙니다.
